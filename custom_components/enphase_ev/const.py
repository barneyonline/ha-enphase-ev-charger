...
CONF_SELECTED_TYPE_KEYS = "selected_type_keys"
CONF_HEATPUMP_DISCOVERY_HANDLED = "heatpump_discovery_handled"
CONF_SITE_ONLY = "site_only"
CONF_INCLUDE_INVERTERS = "include_inverters"
...
MIN_FAST_POLL_INTERVAL = 30
MIN_SLOW_POLL_INTERVAL = 60
...
EVSE_FEATURE_FLAGS_FAILURE_BACKOFF_S = 60.0
DEFAULT_API_TIMEOUT = 15
MIN_API_TIMEOUT = 5
MAX_API_TIMEOUT = 120
DEFAULT_SESSION_HISTORY_INTERVAL_MIN = 10
MIN_SESSION_HISTORY_INTERVAL_MIN = 1
MAX_SESSION_HISTORY_INTERVAL_MIN = 1440
...
HEATPUMP_RUNTIME_STATE_CACHE_TTL = 60.0
HEATPUMP_RUNTIME_STATE_FAILURE_BACKOFF_S = 900.0
HEATPUMP_RUNTIME_STATE_STALE_AFTER_S = 90.0
HEATPUMP_DAILY_CONSUMPTION_CACHE_TTL = 300.0
HEATPUMP_DAILY_CONSUMPTION_FAILURE_BACKOFF_S = 900.0
HEATPUMP_DAILY_CONSUMPTION_STALE_AFTER_S = 900.0
HEATPUMP_POWER_STALE_AFTER_S = 90.0
