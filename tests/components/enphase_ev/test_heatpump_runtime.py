...
async def test_heatpump_power_stops_after_preflight_auth_failure(
    ...
    coord.client.hems_power_timeseries = AsyncMock(side_effect=AssertionError("unused"))
...
async def test_heatpump_runtime_skips_hems_polling_during_auth_circuit(
    ...
    coord.client.hems_power_timeseries = AsyncMock(side_effect=AssertionError)
...
async def test_heatpump_runtime_event_auth_failure_marks_payload_error(
    ...
    coord.client.hems_power_timeseries = AsyncMock(return_value=None)
