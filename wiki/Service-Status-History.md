...
- Latest failed checks: battery_config, system_dashboard
- Retained hourly samples: `358`
...
gantt
    ...
    axisFormat  %b %d
    Window start :vert, window-start, 2026-04-28T11:39:42, 0ms
    Window end :vert, window-end, 2026-05-28T11:39:42, 0ms
    section Down
