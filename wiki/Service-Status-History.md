...
- Last updated: `2026-03-20 23:20 UTC`
- Failed checks in latest run: `0`
- Latest failed checks: None
- Retained hourly samples: `281`
...
gantt
    ...
    axisFormat  %b %d
    Window start :vert, window-start, 2026-02-18T23:20:14, 0ms
    Window end :vert, window-end, 2026-03-20T23:20:14, 0ms
    section Down
