...
- Last updated: `2026-03-22 20:16 UTC`
- Failed checks in latest run: `0`
- Latest failed checks: None
- Retained hourly samples: `320`
...
gantt
    ...
    axisFormat  %b %d
    Window start :vert, window-start, 2026-02-20T20:16:30, 0ms
    Window end :vert, window-end, 2026-03-22T20:16:30, 0ms
    section Down
