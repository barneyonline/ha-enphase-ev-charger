...
- Last updated: `2026-04-05 19:56 UTC`
- Failed checks in latest run: `2`
- Latest failed checks: site_live, battery_config
...
gantt
    ...
    axisFormat  %b %d
    Window start :vert, window-start, 2026-03-06T19:56:05, 0ms
    Window end :vert, window-end, 2026-04-05T19:56:05, 0ms
    section Down
