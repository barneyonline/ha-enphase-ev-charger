...
- Last updated: `2026-03-19 17:48 UTC`
- Failed checks in latest run: `0`
- Latest failed checks: None
- Retained hourly samples: `253`
...
gantt
    ...
    axisFormat  %b %d
    Window start :vert, window-start, 2026-02-17T17:48:00, 0ms
    Window end :vert, window-end, 2026-03-19T17:48:00, 0ms
    section Degraded
