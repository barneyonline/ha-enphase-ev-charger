...
- Last updated: `2026-03-21 07:27 UTC`
- Failed checks in latest run: `0`
- Latest failed checks: None
- Retained hourly samples: `286`
...
gantt
    ...
    axisFormat  %b %d
    Window start :vert, window-start, 2026-02-19T07:27:04, 0ms
    Window end :vert, window-end, 2026-03-21T07:27:04, 0ms
    section Down
